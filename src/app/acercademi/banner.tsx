	...
	return (
		<>
			...
			<div className='flex flex-col md:flex-row justify-between w-full h-auto bg-gradient-to-r from-white via-[#5F39BA] to-[#105881] p-6 md:pl-24 relative'>
				...
				<div className='hidden md:block absolute right-20 top-0 h-full w-1 bg-white bg-opacity-30'></div>
				<div className='hidden md:block absolute right-10 top-0 h-full w-1 bg-white'></div>
